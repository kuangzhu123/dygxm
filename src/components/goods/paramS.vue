<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item :to="{ path: '/usHome' }">首页</el-breadcrumb-item>
...
export default{
    ...
    methods:{
        ...
        async removeParams (attr_id) {
          const cnofirmResult = await this.$confirm('此操作将永久删除该参数, 是否继续?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).catch(err => err)
        // 用户取消了这次操作
        if(cnofirmResult !== 'confirm') {
